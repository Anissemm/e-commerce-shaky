...
const Letter = forwardRef<SVGSVGElement, LetterProps>(({ 
	className,
	strokeColor = 'sandy-brown', 
	fillColor = 'melony-clay', 
	strokeOpacity = 1, 
	fillOpacity = 1, ...props }, ref) => {
	return (
		<svg ref={ref} className={className} viewBox="0 0 512 512" xmlSpace="preserve" {...props}>
			<g>
				<rect x="441.061" y="193.837" style={{ fill: colorMatch[strokeColor], opacity: strokeOpacity }} width="42.511" height="30.214" />
				<rect x="28.43" y="193.837" style={{ fill: colorMatch[strokeColor], opacity: strokeOpacity }} width="39.489" height="30.214" />
			</g >
			<path style={{ fill: colorMatch[fillColor], opacity: fillOpacity }} d="M155.796,119.638l-36.318-18.766c-1.023-0.529-2.237-0.529-3.26,0l-36.318,18.766
	...
	v90.096C160.978,119.142,158.16,120.858,155.796,119.638z"/>
			<g>
				<path style={{ fill: colorMatch[strokeColor], opacity: strokeOpacity }} d="M157.424,135.145c-2.959,0-5.92-0.722-8.563-2.086l-31.014-16.025l-31.014,16.024
		...
		l-56.047-0.13v59.721l19.458-10.054C111.922,86.088,114.882,85.369,117.847,85.369z"/>
				<path style={{ fill: colorMatch[strokeColor], opacity: strokeOpacity }} d="M444.363,402.339H67.637c-8.344,0-15.107-6.763-15.107-15.107V53.087
		...
		C459.47,395.576,452.707,402.339,444.363,402.339z"/>
			...
			<path style={{ fill: colorMatch[fillColor], opacity: fillOpacity }} d="M67.786,496.893h376.428c24.957,0,45.188-20.231,45.188-45.188v-231.4
	...
	c-8.303-5.443-19.329,0.514-19.329,10.44v231.4C22.598,476.662,42.83,496.893,67.786,496.893z"/>
			<g>
				<path style={{ fill: colorMatch[strokeColor], opacity: strokeOpacity }} d="M444.214,512H67.786c-33.247,0-60.295-27.047-60.295-60.295v-231.4
		...
		c-6.763,0-13.326-1.959-18.982-5.667L37.705,225.159z"/>
				<path style={{ fill: colorMatch[strokeColor], opacity: strokeOpacity }} d="M301.321,240.893h-90.641c-8.344,0-15.107-6.763-15.107-15.107s6.763-15.107,15.107-15.107h90.641
		c8.344,0,15.107,6.763,15.107,15.107S309.664,240.893,301.321,240.893z"/>
				<path style={{ fill: colorMatch[strokeColor], opacity: strokeOpacity }} d="M301.321,165.359h-90.641c-8.344,0-15.107-6.763-15.107-15.107c0-8.344,6.763-15.107,15.107-15.107
