...
const Chevron: React.FC<ChevronProps> = ({ cross = false }) => {
    const [alignChevronLeft, setAlignChevronleft] = useState(false)

    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="22" viewBox="0 0 12.158 21.447" fill="none" stroke="#f2aa4c" >
            <motion.g
                    ...
                    {cross &&
                        <>
                            <motion.path
                                ...
                                onAnimationComplete={() => {
                                    if (!cross) {
                                        setAlignChevronleft(true)
                                    }
                                    setAlignChevronleft(false)
